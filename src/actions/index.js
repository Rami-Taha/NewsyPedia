...
const ROOT_SOURCE = `https://beta.newsapi.org/v2/sources?country=us&apiKey=${API_KEY}`;
const HEAD_URL = `https://newsapi.org/v1/articles?source=google-news&sortBy=top&apiKey=${API_KEY}`;
